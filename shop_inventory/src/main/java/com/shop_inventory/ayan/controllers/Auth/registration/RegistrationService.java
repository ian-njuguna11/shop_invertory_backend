...
//import com.shop_inventory.ayan.email.EmailBuilder;
...
//    private final EmailSender emailSender;
    ...
    private final static String INVALID_EMAIL_TYPE = "This % address not valid";
...
//    private EmailSender emailSender;
    ...
    public String register(RegistrationRequest request) {
        ...
        if(!isValid){
            throw new IllegalStateException(String.format(INVALID_EMAIL_TYPE,request.getEmail()));
        }
